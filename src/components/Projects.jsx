...
const projects = [
  ...
  },
  {
    ...
    title: "SkillGraph",
    description:
      "A recruiter tool backed by a graph database (CognoDB) that matches candidates to job openings by tracing skill relationships — surfacing people whose skills are closely related to what's required, even without an exact match.",
